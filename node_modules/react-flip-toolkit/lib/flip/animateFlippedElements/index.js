...
exports.tweenProp = exports.rectInViewport = exports.createApplyStylesFunc = exports.invertTransformsForChildren = exports.convertMatrix2dArrayToString = exports.convertMatrix3dArrayTo2dArray = undefined;
...
var _filterFlipDescendants = require("./filterFlipDescendants");

var _filterFlipDescendants2 = _interopRequireDefault(_filterFlipDescendants);

var _initiateAnimations = require("./initiateAnimations");

var _initiateAnimations2 = _interopRequireDefault(_initiateAnimations);
...
var convertMatrix3dArrayTo2dArray = exports.convertMatrix3dArrayTo2dArray = function convertMatrix3dArrayTo2dArray(matrix) {
  return [0, 1, 4, 5, 12, 13].map(function (index) {
    return matrix[index];
  });
};

var convertMatrix2dArrayToString = exports.convertMatrix2dArrayToString = function convertMatrix2dArrayToString(matrix) {
  return "matrix(" + matrix.join(", ") + ")";
};

var invertTransformsForChildren = exports.invertTransformsForChildren = function invertTransformsForChildren(_ref) {
...
var createApplyStylesFunc = exports.createApplyStylesFunc = function createApplyStylesFunc(_ref3) {
...
var rectInViewport = exports.rectInViewport = function rectInViewport(_ref5) {
  var top = _ref5.top,
      bottom = _ref5.bottom,
      left = _ref5.left,
      right = _ref5.right;
...
var getInvertedChildren = function getInvertedChildren(element, id) {
  return (0, _utilities.toArray)(element.querySelectorAll("[" + constants.DATA_INVERSE_FLIP_ID + "=\"" + id + "\"]"));
};

var tweenProp = exports.tweenProp = function tweenProp(start, end, position) {
...
var animateFlippedElements = function animateFlippedElements(_ref6) {
  ...
  .map(function (id) {
    ...
    var onAnimationEnd = function onAnimationEnd() {
      ...
      (0, _utilities.isFunction)(onComplete) && onComplete();
    ...
    var animateOpacity = (0, _utilities.isNumber)(fromVals.opacity) && fromVals.opacity !== toVals.opacity;
  ...
  var _filterFlipDescendant = (0, _filterFlipDescendants2.default)({
    flipDict: flipDict,
  ...
  return function () {
    ...
    (0, _initiateAnimations2.default)({ topLevelChildren: topLevelChildren, flipDict: flipDict, staggerConfig: staggerConfig });
    return flipCompletedPromise;
  };
};

exports.default = animateFlippedElements;